...
public class UpgradeFactory {
    ...
    public void initializeUpgrades() {
        ...
        new Upgrade("Click Income Boost", doubleClickEffects, 10, state, incomeManager, populationManager);
        ...
        new Upgrade("Passive Income Boost", passiveIncomeEffects, 10, state, incomeManager, populationManager);
        ...
        new Upgrade("Population Growth", populationEffects, 500, state, incomeManager, populationManager);
